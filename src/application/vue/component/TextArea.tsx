		...
		<>
            ...
            focus-within:ring-2 focus-within:ring-black focus-within:ring-offset-2">
				<div className="relative grow">
					<textarea
						className="!tracking-normal bg-transparent peer leading-[48px] placeholder:leading-[48px] pt-8 placeholder-transparent text-sm block p-4 w-full rounded-[8px] text-black transition duration-75 ease-out !outline-none resize-none"
						aria-invalid="false" id={id} onChange={onChange} value={value} required={required} cols={10}>
					</textarea>
