...
function Input({id, label, type, onChange, value, required}: InputTextProps) {
	...
	if (type === "password" && !showPassword) {
		return (
            ...
            focus-within:ring-2 focus-within:ring-black focus-within:ring-offset-2">
				<div className="relative grow">
					<input name={id} required={required} type="password" placeholder="Email or username" onChange={onChange} aria-invalid="false" id={id} className="!tracking-normal bg-transparent peer leading-[48px] placeholder:leading-[48px] pt-8 placeholder-transparent text-sm h-12 block p-4 w-full rounded-[8px] text-black transition duration-75 ease-out !outline-none" value={value} />
		...
		return (
            ...
            focus-within:ring-2 focus-within:ring-black focus-within:ring-offset-2">
				<div className="relative grow">
					<input name={id} required={required} type="text" placeholder="Email or username" onChange={onChange} aria-invalid="false" id={id} className="!tracking-normal bg-transparent peer leading-[48px] placeholder:leading-[48px] pt-8 placeholder-transparent text-sm h-12 block p-4 w-full rounded-[8px] text-black transition duration-75 ease-out !outline-none" value={value} />
